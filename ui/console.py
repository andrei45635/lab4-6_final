...
def afiseaza_meniu():
    ...
    print("9) elimina pachetele care contin luna pe care userul o inputeaza")
    ...
    print("12) elimina pachetele cu o destinatie diferita de cea data si cu un pret mai mare decat o suma data ")
