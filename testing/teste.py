...
from domain.pachet import adauga_pachet_in_lista
...
def test_cautare_valid_si_print_lst_m():
    ...
    #assert print_lst_m(lst_m) == [[datetime.date(2021, 08, 04), datetime.date(2022, 08, 20), 'Galati', 9000.1],[datetime.date(2021, 08, 24), datetime.date(2022, 08, 29), 'Galati', 9011.0]]
    try:
        eliminare_pret_dest(l, "Braila", 12400, lst_m)
        assert True
    except KeyError:
